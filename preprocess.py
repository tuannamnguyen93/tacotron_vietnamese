...
def norm_data(args):
	...
	supported_datasets = ['fpt', 'LJSpeech-1.1', 'M-AILABS']
	if args.dataset not in supported_datasets:
		raise ValueError('dataset value entered {} does not belong to supported datasets: {}'.format(
			args.dataset, supported_datasets))

	if args.dataset.startswith('fpt'):
...
def main():
	...
	parser.add_argument('--base_dir', default=os.path.expanduser('~/4Tb/Dungtv/pycharm_nal/tacotron_2_2'))
	parser.add_argument('--dataset', default='fpt')
